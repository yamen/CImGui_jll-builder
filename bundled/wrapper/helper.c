...
// 1.81 removed void* ImGuiIO_Get_ImeWindowHandle(ImGuiIO* io) { return io->ImeWindowHandle; }
// 1.81 removed void* ImGuiIO_Get_RenderDrawListsFnUnused(ImGuiIO* io) { return io->RenderDrawListsFnUnused; }
...
// 1.81 removed void ImGuiIO_Set_ImeSetInputScreenPosFn(ImGuiIO* io, void* x) { io->ImeSetInputScreenPosFn = x; }
// 1.81 removed void ImGuiIO_Set_ImeWindowHandle(ImGuiIO* io, void* x) { io->ImeWindowHandle = x; }
// 1.81 removed void ImGuiIO_Set_RenderDrawListsFnUnused(ImGuiIO* io, void* x) { io->RenderDrawListsFnUnused = x; }
